...
class PostUpdateScript extends Script
{
    public static function execute(): void
    {
        ...
        self::runPHP(['vendor/bolt-oss/core/bin/fix-bundles']);
        self::runPHP(['vendor/bobdenotter/yaml-migrations/bin/yaml-migrate', 'process', '-c', 'vendor/bolt-oss/core/yaml-migrations/config.yaml', '-v']);
